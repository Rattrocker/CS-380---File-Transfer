...
//            outputLine = serverProtocol.processInput(null);                  //it goes into serverProtocol and into processInput() for the first time.
...
//                outputLine = serverProtocol.processInput(inputLine);          //sends in what the client said to be checked in the ServerProtocol class
//                out.println(outputLine);                                //prints out the appropriate response from ServerProtocol class
